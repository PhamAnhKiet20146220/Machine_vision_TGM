        ...
        public List<Bitmap> ChuyenDoiRGBSangHSI(Bitmap HinhGoc)
        {
            ...
            for (int x = 0; x < HinhGoc.Width; x++)
                for (int y = 0; y < HinhGoc.Height; y++)
                {
                    ...
                    // ép kiểu các giá trị H - S - I về kiểu byte 
                    ...
                    // giá trị gốc của S dùng để tạo hình HSI. Hình HSI để quan sát, còn tính tính vẫn dùng các kênh riêng lẽ
                    // với tửng mục đính ảnh khác nhau
                    HSIImg.SetPixel(x,y,Color.FromArgb((byte)H, (byte)(S*255), (byte)I)); // muốn như ảnh trên gg.doc thì S*255
